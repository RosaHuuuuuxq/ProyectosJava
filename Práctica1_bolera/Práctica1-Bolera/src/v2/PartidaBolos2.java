...
public class PartidaBolos2 {
	...
	public static void main(String[] args) {
		...
		Jugador2 jugador1 = new Jugador2 (nombre1);
		Jugador2 jugador2 = new Jugador2 (nombre2);
		...
		//conparamos las puntuaciones para determinar el ganador con if else
